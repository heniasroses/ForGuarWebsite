...
export default function AdminForestLogViewModal({
  log,
  onClose,
  onDeleted,
}: Props) {
  ...
  const handleDelete = async () => {
    ...
    if (error) {
      console.log(error);
      setErrorMessage(
        error.message || "Delete failed. Check your database permissions."
      );
    ...
    <>
      ...
      >
        ...
        >
          ...
          {errorMessage && <div className="formErrorBox">{errorMessage}</div>}
